...
public class ShoppingCartRestController {
	...
	public ResponseEntity<List<ShoppingCart>> getShoppingCartsByUserName(@PathVariable String userName)
			throws ShoppingCartListNotFoundException {
	...
	public ResponseEntity<?> removeProduct(@PathVariable String cartId, @PathVariable Integer productId)
			throws ShoppingCartListNotFoundException, ProductNotFoundException {
